  ...
  return (
    <section className="pt-4 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA] uppercase tracking-tight text-2xl">
            Mis créditos
          </h1>
        ...
        <Link
          href="/packs"
          className="inline-flex items-center gap-1.5 px-3 py-2 bg-[#F78837] text-[#0A1F2A] text-xs font-[family-name:var(--font-oswald)] font-bold uppercase tracking-wide active:scale-[0.98] transition-transform"
        >
          Comprar
        </Link>
      </div>
      ...
      <div className="bg-[#0E2A38] border border-[#1A4A63] p-5">
        <div className="flex items-center gap-4">
          <div className="size-14 border border-[#F78837]/30 bg-[#F78837]/10 flex items-center justify-center shrink-0">
            <Wallet size={24} weight="bold" className="text-[#F78837]" />
          </div>
          <div>
            <p className="text-[10px] font-[family-name:var(--font-jetbrains)] uppercase tracking-wider text-[#6B8A99]">
              Disponibles
            </p>
            <p className="font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA] text-3xl leading-none mt-0.5">
              {totalCredits}{" "}
              <span className="text-lg text-[#6B8A99]">
        ...
        <div className="flex items-center gap-6 mt-4 pt-4 border-t border-[#1A4A63]">
          <div>
            <p className="text-[10px] font-[family-name:var(--font-jetbrains)] uppercase tracking-wider text-[#4A6B7A]">
              Abonos activos
            </p>
            <p className="text-sm font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA] mt-0.5">
              {activeSubs.length}
            </p>
          </div>
          {nextExpiry !== null && (
            <div>
              ...
              <p
                className={cn(
                  "text-sm font-[family-name:var(--font-oswald)] font-bold mt-0.5",
      ...
      {activeSubs.length > 0 && (
        <div className="space-y-3">
          <h2 className="font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA] uppercase tracking-tight text-lg">
            Abonos activos
          </h2>
          ...
          <div className="space-y-3">
            {activeSubs.map((sub) => {
              ...
              return (
                <div
                  key={sub.id}
                  className="bg-[#0E2A38] border border-[#1A4A63] p-4"
                >
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <p className="text-sm font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA] uppercase tracking-tight">
                        {sub.pack?.name ?? "Abono"}
                      </p>
                      <p className="text-[11px] text-[#4A6B7A] mt-0.5 font-[family-name:var(--font-jetbrains)]">
                        Comprado{" "}
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-sm font-[family-name:var(--font-oswald)] font-bold text-[#27C7B8]">
                        {sub.remaining}
                        <span className="text-[#6B8A99] text-xs">
                          /{sub.creditsGranted}
                        </span>
                      </p>
                      <p className="text-[10px] text-[#4A6B7A] font-[family-name:var(--font-jetbrains)]">
                        restantes
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Barra de progreso */}
                  <div className="mt-3 h-1 bg-[#1A4A63] overflow-hidden">
                    <div
                      className={cn(
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <p className="text-[10px] font-[family-name:var(--font-jetbrains)] text-[#4A6B7A] uppercase tracking-wider">
                      {sub.used} usadas
                    </p>
                    {sub.expiresAt && (
                      <p
                        className={cn(
                          "text-[10px] font-[family-name:var(--font-jetbrains)] uppercase tracking-wider",
                          sub.isExpiringSoon
                            ? "text-[#F78837]"
                            : "text-[#4A6B7A]",
                        )}
      ...
      <div className="space-y-3">
        ...
        {visibleTransactions.length === 0 ? (
          <div className="bg-[#0E2A38] border border-[#1A4A63] px-4 py-12 text-center">
            <Clock size={24} className="text-[#1A4A63] mx-auto mb-2" />
            ...
            {visibleTransactions.map((tx) => {
              ...
              return (
                <div key={tx.id} className="flex items-start gap-3 px-4 py-3.5">
                  ...
                  <div
                    className={cn(
                      "size-9 border flex items-center justify-center shrink-0 mt-0.5",
                      isPositive
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={cn(
                          "text-xs font-[family-name:var(--font-oswald)] font-bold tabular-nums shrink-0",
                    ...
                    {/* Fecha */}
                    <p className="text-[10px] text-[#4A6B7A] mt-1 font-[family-name:var(--font-jetbrains)] tabular-nums">
