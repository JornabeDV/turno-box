...
export default async function GymsPage({
  ...
  return (
    <main className="min-h-dvh bg-page flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md relative">
        ...
        <h1 className="font-[family-name:var(--font-oswald)] font-bold text-primary uppercase tracking-tight text-2xl mb-2 text-center">
          Encontrá tu gimnasio
        </h1>
        <p className="text-sm sm:text-base text-secondary text-center mb-8 font-[family-name:var(--font-oswald)]">
          Buscá tu gimnasio y unite para reservar clases
        </p>

        <GymDiscoveryClient initialGyms={gyms} initialQuery={q ?? ""} />

        <p className="text-center text-xs sm:text-sm text-secondary mt-8 font-[family-name:var(--font-oswald)] uppercase tracking-wide">
