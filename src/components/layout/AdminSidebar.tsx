  ...
  return (
    <aside className="hidden md:flex flex-col w-56 min-h-dvh border-r border-border bg-page p-4 gap-1">
      ...
      <div className="flex justify-center gap-1 px-2 py-3 mb-3">
        <div className="w-28 h-28 rounded-xl border border-border bg-card overflow-hidden flex items-center justify-center p-2">
          <img
      ...
      {NAV_ITEMS.map(({ href, label, Icon }) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={cn(
              "flex items-center gap-3 px-3 lg:px-4 py-2.5 lg:py-3 rounded-[2px] text-sm lg:text-base font-medium transition-colors duration-150",
              "active:scale-[0.97]",
              active
