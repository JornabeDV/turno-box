  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      {/* <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          className="flex items-center justify-center gap-2 h-12 border border-[#1A4A63] bg-[#0E2A38] text-[#EAEAEA] hover:border-[#F78837] transition-colors text-xs font-[family-name:var(--font-oswald)] uppercase tracking-wide"
        >
