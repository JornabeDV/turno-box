  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="name" className="text-xs sm:text-sm font-medium text-[#6B8A99] uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Nombre completo
        </label>
      ...
      {/* Password */}
      <div className="flex flex-col gap-2">
        <label htmlFor="password" className="text-xs sm:text-sm font-medium text-[#6B8A99] uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Contraseña
        </label>
        <div className="relative">
      ...
      {/* Confirm Password */}
      <div className="flex flex-col gap-2">
        <label htmlFor="confirmPassword" className="text-xs sm:text-sm font-medium text-[#6B8A99] uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Repetir contraseña
        </label>
        <div className="relative">
          <Lock size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#4A6B7A]" />
      ...
      {/* Birth date */}
      <div className="flex flex-col gap-2">
        <label className="text-xs sm:text-sm font-medium text-[#6B8A99] uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Fecha de nacimiento
        </label>
      ...
      {error && (
        <div className="flex items-center gap-2 border-l-2 border-[#E61919] bg-[#0E2A38] px-3 py-2.5">
          ...
          <p className="text-xs sm:text-sm text-[#E61919] font-[family-name:var(--font-oswald)] uppercase tracking-wide">{error}</p>
        </div>
      )}
      ...
      {success && (
        <div className="flex items-center gap-2 border-l-2 border-[#27C7B8] bg-[#0E2A38] px-3 py-2.5">
          ...
          <p className="text-xs sm:text-sm text-[#27C7B8] font-[family-name:var(--font-oswald)] uppercase tracking-wide">Cuenta creada. Redirigiendo...</p>
        </div>
      )}
