  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="name" className="text-xs sm:text-sm font-medium text-secondary uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Nombre completo
        </label>
      ...
      {/* Password */}
      <div className="flex flex-col gap-2">
        <label htmlFor="password" className="text-xs sm:text-sm font-medium text-secondary uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Contraseña
        </label>
        <div className="relative">
      ...
      {/* Confirm Password */}
      <div className="flex flex-col gap-2">
        <label htmlFor="confirmPassword" className="text-xs sm:text-sm font-medium text-secondary uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Repetir contraseña
        </label>
        <div className="relative">
          <Lock size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted" />
      ...
      {/* Birth date */}
      <div className="flex flex-col gap-2">
        <label className="text-xs sm:text-sm font-medium text-secondary uppercase tracking-wider font-[family-name:var(--font-oswald)]">
          Fecha de nacimiento
        </label>
      ...
      {error && (
        <div className="flex items-center gap-2 border-l-2 border-danger bg-card px-3 py-2.5">
          ...
          <p className="text-xs sm:text-sm text-danger font-[family-name:var(--font-oswald)] uppercase tracking-wide">{error}</p>
        </div>
      )}

      {success && (
        <div className="flex items-center gap-2 border-l-2 border-success bg-card px-3 py-2.5">
          <CheckCircle size={15} className="text-success shrink-0" />
          <p className="text-xs sm:text-sm text-success font-[family-name:var(--font-oswald)] uppercase tracking-wide">Cuenta creada. Redirigiendo...</p>
        </div>
      )}
