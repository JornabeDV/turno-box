...
const STEPS_ANDROID = [
  ...
  },
  {
    ...
    body: 'Ajustes del celular → Aplicaciones → Box Turno → Batería → "Sin restricciones". Esto permite recibir notificaciones aunque la app esté cerrada.',
  },
];
...
const STEPS_IOS = [
  ...
  },
  {
    ...
    body: "Cerrá Safari y abrí Box Turno desde el ícono en tu pantalla de inicio. Esto es necesario para que las notificaciones funcionen.",
  },
  {
    step: "4",
    title: "Activá las notificaciones",
