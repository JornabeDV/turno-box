      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
          {PLANS.map((plan) => (
            ...
            >
              <h3 className="text-sm font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA] uppercase tracking-tight">
                {plan.name}
              </h3>
              <div className="mt-3 mb-4">
                <span className="text-2xl font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA]">
                  {plan.price}
                </span>
              ...
              <ul className="space-y-2 mb-6 flex-1">
                {plan.features.map((f) => (
                  <li
                    key={f}
                    className="flex items-center gap-2 text-xs text-[#6B8A99] font-[family-name:var(--font-oswald)]"
                  >
              ...
              <a
                ...
                className={`w-full text-center py-2.5 text-xs font-[family-name:var(--font-oswald)] font-bold uppercase tracking-wide transition-colors ${
                  plan.highlighted
