      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="bg-[#0A1F2A] border border-[#1A4A63] p-6 text-center">
            ...
            <div className="text-3xl lg:text-4xl font-[family-name:var(--font-oswald)] font-bold text-[#EAEAEA]">
              +35%
            </div>
            <div className="text-[10px] lg:text-xs text-[#6B8A99] font-[family-name:var(--font-jetbrains)] uppercase tracking-wider mt-1">
              Ocupación promedio
            </div>
          </div>
          <div className="bg-[#0A1F2A] border border-[#1A4A63] p-6 text-center">
